...
Namespace My
    ...
    Partial Friend Class MyApplication
        ...
        Private Sub Application_ThreadException(ByVal sender As Object, ByVal e As Threading.ThreadExceptionEventArgs)
            ...
            Try
                Global.morokot.frmMessageError.ShowBoxError(e.Exception.Message, "Error")
            Catch
            End Try
        End Sub
        ...
        Private Sub CurrentDomain_UnhandledException(ByVal sender As Object, ByVal e As UnhandledExceptionEventArgs)
            Try
                ...
                If ex IsNot Nothing Then
                    ...
                    Try
                        Global.morokot.frmMessageError.ShowBoxError(ex.Message, "Unhandled Error")
                    Catch
                    End Try
                Else
