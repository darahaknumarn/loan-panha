...
Public Class frm_Restore
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        If ProgressBar1.Value = 100 Then
            ...
            Try
                ...
                'Dim CMD As String = "use master RESTORE DATABASE " & cbDatabseDatabase.Text.ToUpper & " FROM DISK = N'" & txtdestination.Text & "' WITH REPLACE"
            ...
            Catch ex As Exception
                MsgBox(ex.ToString, "For Server only!", MsgBoxStyle.Information)
                ProgressBar1.Visible = False
                Label1.Visible = False
            End Try
        End If
    ...
    Private Sub txtRestore_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRestore.Click
        if cbDatabseDatabase.Text="" Or txtdestination.Text=""
