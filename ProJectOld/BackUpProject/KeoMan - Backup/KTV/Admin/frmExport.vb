...
Public Class frmExport
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            Dim cmd As String = "Use TempMorokot BACKUP DATABASE TempMorokot TO  DISK = N'" & appPath & "\Export\Export " & frmMain.lblCode.Text & " " & Year(DateTimePicker1.Value) & "-" & Month(DateTimePicker1.Value) & "-" & days1 & ".bak' WITH NOFORMAT, INIT,  NAME = N'TempMorokot-Full Database Backup', SKIP, NOREWIND, NOUNLOAD,  STATS = 10"
