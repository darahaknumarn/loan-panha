Public Class frmReport
    ...
    Private Sub frmReport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Label1.Text = Me.Text
        If Me.Text = "Loan Arrears Detail" Or Me.Text = "Loan Arrears Summary By CO" Or Me.Text = "Loan Outstanding Detail" Or Me.Text = "Loan Outstanding Summary by CO" Or Me.Text = "Write Off Summary By CO" Or Me.Text = "Write Off Summary By Branch" Then
        ...
        ElseIf Me.Text = "LoanToRepayByBranch" Then
            trues()
            lblCurrency.Visible = False
            cboCurrency.Visible = False
        ElseIf Me.Text = "បញ្ចេញឥណទាន" Or Me.Text = "Bank Transaction" Or Me.Text = "Inactive Loan Income" Or Me.Text = "Summary Disbursement by CO" Or Me.Text = "Summary Disbursement by Branch" Then
        ...
        ElseIf Me.Text = "LoanSummaryByBranch" Then
            ...
            lblCurrency.Enabled = False
            cboCurrency.Enabled = False
        ElseIf Me.Text = "Interest Summary" Or Me.Text = "Interest Detail" Or Me.Text = "WriteOff" Or Me.Text = "Summary Income by CO" Or Me.Text = "Summary Income by Branch" Then
            lblCurrency.Enabled = False
            cboCurrency.Enabled = False
            lblWF.Enabled = False
            cboWF.Enabled = False
