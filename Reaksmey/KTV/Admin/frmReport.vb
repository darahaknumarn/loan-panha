Public Class frmReport
    ...
    Private Sub frmReport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ElseIf Me.Text = "ការដាក់ និងដកទុន" Or Me.Text = "Summary loan to pay" Or Me.Text = "Summary loan paid" Or Me.Text = "Incorrect Repay" Or Me.Text = "SummaryLoanPaidByBranch" Then
            trues()
            lblCurrency.Visible = False
            cboCurrency.Visible = False
        ...
        ElseIf Me.Text = "LoanSummaryByBranch" Then
            ...
            lblCurrency.Enabled = False
            cboCurrency.Enabled = False
        ElseIf Me.Text = "Interest Summary" Or Me.Text = "Interest Detail" Then
            lblCurrency.Enabled = False
            cboCurrency.Enabled = False
