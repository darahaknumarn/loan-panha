...
Public Class frmResultReport
    Private Sub frmResultReport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim BrId As String = Nothing
        If frmReport.lblBranch.Text = "All" Or frmReport.cboBranch.Text = "all" Then
            BrId = "%"
        Else
            BrId = frmReport.cboBranch.Text
        End If
        ...
        ElseIf lblNameReport.Text = "AssetPaidOff" Then
            ForGrid(Me.DataGridView1, "exec sp_rptAssetPaidOff '" & lblStartDate.Text & "','" & lblEndDate.Text & "','All','" & BrId & "'")
        ...
        ElseIf lblNameReport.Text = "បានយកប្រាក់ពីអតិថិជន" Then '------------------------ Laon Paid Detail ------------------'ReadyWF
            ShowDataGrid(DataGridView1, "exec sp_rptGetLoanPaid '" & lblStartDate.Text & "','" & lblEndDate.Text & "','" & frmReport.cboBranch.Text & "','" & frmReport.cboEmployee.Text & "',N'" & frmReport.cboCurrency.Text & "','" & frmReport.cboWF.SelectedIndex.ToString & "'")
        ...
        ElseIf lblNameReport.Text = "ស្តីពីប្រាក់សង្ខេប" Then
            SP_EndBalance()
            AddToGrid(DataGridView1, 7, "exec sp_rptEndBalSumByEndDay '" & lblStartDate.Text & "','" & lblEndDate.Text & "','" & frmReport.cboBranch.Text & "'")
        ...
        ElseIf lblNameReport.Text = "Loan Outstanding Detail" Then
            ShowDataGrid(Me.DataGridView1, "exec sp_rptGetLoanOSWithoutWriteoff '" & lblStartDate.Text & "','" & frmReport.cboBranch.Text & "','All','All'")
        ...
        ElseIf lblNameReport.Text = "Loan Outstanding Summary by CO" Then
            ShowDataGrid(Me.DataGridView1, "exec sp_rptGetLoanOSWithoutWriteoff '" & lblStartDate.Text & "','" & frmReport.cboBranch.Text & "'")
        ...
        ElseIf lblNameReport.Text = "WriteOff" Then
            ShowDataGrid(Me.DataGridView1, "Exec sp_rptWF '" & lblStartDate.Text & "','" & lblEndDate.Text & "','" & frmReport.cboEmployee.Text & "','" & frmReport.cboBranch.Text & "'")
        ElseIf lblNameReport.Text = "Summary Disbursement by CO" Then
            ShowDataGrid(Me.DataGridView1, "Exec sp_rptLoanDisbursmentByCO '" & lblStartDate.Text & "','" & lblEndDate.Text & "','" & frmReport.cboBranch.Text & "','All','All'")
        ElseIf lblNameReport.Text = "Summary Disbursement by Branch" Then
            ShowDataGrid(Me.DataGridView1, "Exec sp_rptLoanDisbursmentByBrand '" & lblStartDate.Text & "','" & lblEndDate.Text & "','" & frmReport.cboBranch.Text & "','All','All'")
        ElseIf lblNameReport.Text = "Summary Income by CO" Then
            ShowDataGrid(Me.DataGridView1, "Exec sp_rptSumIncomeByCO '" & lblStartDate.Text & "','" & lblEndDate.Text & "','" & frmReport.cboEmployee.Text & "','" & frmReport.cboBranch.Text & "'")
        ElseIf lblNameReport.Text = "Summary Income by Branch" Then
            ShowDataGrid(Me.DataGridView1, "Exec sp_rptSumIncomeByBrand '" & lblStartDate.Text & "','" & lblEndDate.Text & "','" & frmReport.cboEmployee.Text & "','" & frmReport.cboBranch.Text & "'")
        ElseIf lblNameReport.Text = "Write Off Summary By CO" Then
            ForGrid(DataGridView1, "exec sp_rptWriteOffSummaryByCO '" & lblStartDate.Text & "','" & frmReport.cboBranch.Text & "',N'" & frmReport.cboCurrency.Text & "','" & frmReport.cboEmployee.Text & "'")
        ElseIf lblNameReport.Text = "Write Off Summary By Branch" Then
            ForGrid(DataGridView1, "exec sp_rptWriteOffSummaryByBranch '" & lblStartDate.Text & "','" & frmReport.cboBranch.Text & "',N'" & frmReport.cboCurrency.Text & "','" & frmReport.cboEmployee.Text & "'")
        End If
    End Sub
    ...
    Private Sub SP_EndBalance()
        ...
        DataGridView1.Columns(2).Name = "ឈ្មោះសាខា"
        DataGridView1.Columns(3).Name = "ចំណូលរៀល"
        DataGridView1.Columns(4).Name = "ចំណូលដុល្លារ"
        DataGridView1.Columns(5).Name = "ចុងគ្រារៀល"
        DataGridView1.Columns(6).Name = "ចុងគ្រាដុល្លារ"
    End Sub
    Private Sub SP_Own()
        SetFontDatagrid(DataGridView1)
        DataGridView1.Columns.Clear()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        ElseIf Me.lblNameReport.Text = "Loan Arrears Detail" Then
            ToFormatExcel("ArrearsDetail.xlsx", "Sheet1", "B10:B", 6, "A6", 8)
        ElseIf Me.lblNameReport.Text = "ត្រូវយកប្រាក់ពីអតិថិជន" Then
            ToFormatExcel("LDToPayDetail.xlsx", "Sheet1", "B10:B", 6, "A6", 8)
        ElseIf Me.lblNameReport.Text = "ProfitByBrand" Then
            ToFormatExcel("Summery-Profit-By-Branch.xlsx", "Sheet1", "B10:B", 6, "A6", 10)
        ElseIf Me.lblNameReport.Text = "ស្តីពីប្រាក់សង្ខេប" Then
            ToFormatExcelEnding("EndingBalance.xlsx", "Sheet1", "B8:B", 4, "A3", 6)
        ElseIf Me.lblNameReport.Text = "Loan Outstanding Detail" Then
            ToFormatExcel("LDOSDetail.xlsx", "Sheet1", "B10:B", 6, "A6", 8)
        ElseIf Me.lblNameReport.Text = "Summary Disbursement by CO" Then
            ToFormatExcel("LoanDisburse-Summery-by-CO.xlsx", "Sheet1", "B10:B", 6, "A6", 9)
        ElseIf Me.lblNameReport.Text = "Summary Disbursement by Branch" Then
            ToFormatExcel("LoanDisburse-Summery-by-Branch.xlsx", "Sheet1", "B10:B", 6, "A6", 9)

        ElseIf Me.lblNameReport.Text = "Summary Income by CO" Then
            ToFormatExcel("SummeryIncome-by-CO.xlsx", "Sheet1", "B10:B", 6, "A6", 9)
        ElseIf Me.lblNameReport.Text = "Summary Income by Branch" Then
            ToFormatExcel("SummeryIncome-by-Branch.xlsx", "Sheet1", "B10:B", 6, "A6", 9)

        ElseIf Me.lblNameReport.Text = "Write Off Summary By CO" Then
            ToFormatExcel("Written Off-Summery-by-CO.xlsx", "Sheet1", "B10:B", 6, "A6", 9)
        ElseIf Me.lblNameReport.Text = "Write Off Summary By Branch" Then
            ToFormatExcel("Written Off-Summery-by-branch.xlsx", "Sheet1", "B10:B", 6, "A6", 9)
    ...
    Private Sub toExcelFormat()
        Try
            ...
            If frmReport.cboBranch.Text = "All" Or frmReport.cboBranch.Text = "all" Then
                BrId = "%"
            Else
                BrId = frmReport.cboBranch.Text
            End If
            Dim count As Integer = getData("exec sp_CountAsset '" & lblStartDate.Text & "','" & lblEndDate.Text & "','" & BrId & "'")
            'Dim count As Integer = getData("select count(ASID) Num from (select ASID from ExpenseOperation where OPDate between '" & lblStartDate.Text & "' and '" & lblEndDate.Text & "' and BrID like '" & BrId & "' and OPTerm=1 group by ASID) a")
            Dim dscmd As New SqlDataAdapter(sql, g_cnn)
            Dim ds As New DataSet()
            dscmd.Fill(ds)
            With excelWorksheet
                If count >= 3 Then
                    .Range("B31:B" & count + 27).EntireRow.Insert()
                End If
    ...
    Private Sub ToFormatExcelEnding(ByVal ExcelName As String, ByVal SheetName As String, ByVal RangeInsert As String, ByVal RowNum As Integer, ByVal Date1 As String, ByVal RowFill As Integer)
        Try
            Dim connectionString As String = Nothing
            Dim sql As String = Nothing
            Dim data As String = Nothing
            ...
            With excelWorksheet
                ...
                For i = 0 To rowsTotal
                    For j = 0 To colsTotal
                        ...
                        If i + RowFill >= RowFill + 1 And j = 6 Or i + RowFill >= RowFill + 1 And j = 7 Then
                            .Cells(i + RowFill, 6).value = Val(.Cells(i + RowFill - 1, 6).value) + val(.Cells(i + RowFill, 4).value)
                            .Cells(i + RowFill, 7).value = Val(.Cells(i + RowFill - 1, 7).value) + val(.Cells(i + RowFill, 5).value)
                        End If
