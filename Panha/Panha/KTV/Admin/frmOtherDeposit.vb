...
Public Class frmOtherDeposit
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        AddToGridOther(DataGridView1, 12, "select 'Saved',a.LD_ID,a.Date_Payoff,b.EM_ID,c.EM_Name,a.CM_ID,d.CM_KhName,d.CM_Phone" _
...
& " where a.Date_Payoff ='' and a.LD_BrId='001'")
    End Sub
