Public Class frmMain
    ...
    Private Sub AssetPaidOffToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AssetPaidOffToolStripMenuItem.Click
        For Each Form In Me.MdiChildren
            Form.Close()
        Next
        frmReport.Text = "AssetPaidOff"
        frmReport.MdiParent = Me
        frmReport.Show()
    End Sub
    ...
    Private Sub WriteOffToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles WriteOffToolStripMenuItem1.Click
        For Each Form In Me.MdiChildren
            Form.Close()
        Next
        frmReport.Text = "WriteOff"
        frmReport.MdiParent = Me
        frmReport.Show()
    End Sub

    Private Sub SummaryDisbursementByCOToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SummaryDisbursementByCOToolStripMenuItem.Click
        For Each Form In Me.MdiChildren
            Form.Close()
        Next
        frmReport.Text = "Summary Disbursement by CO"
        frmReport.MdiParent = Me
        frmReport.Show()
    End Sub

    Private Sub SummaryDisbursementByBranchToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SummaryDisbursementByBranchToolStripMenuItem.Click
        For Each Form In Me.MdiChildren
            Form.Close()
        Next
        frmReport.Text = "Summary Disbursement by Branch"
        frmReport.MdiParent = Me
        frmReport.Show()
    End Sub

    Private Sub SummaryIncomeByCOToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SummaryIncomeByCOToolStripMenuItem.Click
        For Each Form In Me.MdiChildren
            Form.Close()
        Next
        frmReport.Text = "Summary Income by CO"
        frmReport.MdiParent = Me
        frmReport.Show()
    End Sub

    Private Sub SummaryIncomeByBranchToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SummaryIncomeByBranchToolStripMenuItem.Click
        For Each Form In Me.MdiChildren
            Form.Close()
        Next
        frmReport.Text = "Summary Income by Branch"
        frmReport.MdiParent = Me
        frmReport.Show()
    End Sub

    Private Sub WriteOffDetailToolStripMenuItem_Click(sender As Object, e As EventArgs)
        For Each Form In Me.MdiChildren
            Form.Close()
        Next
        frmReport.Text = "Write Off"
        frmReport.MdiParent = Me
        frmReport.Show()
    End Sub
    ...
    Private Sub WToolStripMenuItem_Click(sender As Object, e As EventArgs)
        For Each Form In Me.MdiChildren
            Form.Close()
        Next
        frmReport.Text = "Write Off Summary Detail"
        frmReport.MdiParent = Me
        frmReport.Show()
    End Sub

    Private Sub WriteOffSummaryByCOToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles WriteOffSummaryByCOToolStripMenuItem.Click
        For Each Form In Me.MdiChildren
            Form.Close()
        Next
        frmReport.Text = "Write Off Summary By CO"
        frmReport.MdiParent = Me
        frmReport.Show()
    End Sub

    Private Sub WriteOffSummaryByBrandToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles WriteOffSummaryByBrandToolStripMenuItem.Click
        For Each Form In Me.MdiChildren
            Form.Close()
        Next
        frmReport.Text = "Write Off Summary By Branch"
        frmReport.MdiParent = Me
        frmReport.Show()
    End Sub
End Class