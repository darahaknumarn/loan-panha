Public Class frmMain
    ...
    Private Sub SummaryIncomeByCOToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles SummaryIncomeByCOToolStripMenuItem1.Click
        For Each Form In Me.MdiChildren
            Form.Close()
        Next
    ...
    Private Sub SummaryIncomeByBranchToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles SummaryIncomeByBranchToolStripMenuItem1.Click
        For Each Form In Me.MdiChildren
            Form.Close()
        Next
    ...
    Private Sub SummaryDisbursementByCOToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles SummaryDisbursementByCOToolStripMenuItem1.Click
        For Each Form In Me.MdiChildren
            Form.Close()
        Next
    ...
    Private Sub SummaryDisbursementByBranchToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles SummaryDisbursementByBranchToolStripMenuItem1.Click
        For Each Form In Me.MdiChildren
            Form.Close()
        Next
