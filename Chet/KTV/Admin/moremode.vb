...
errL:
    ...
    '    Public Sub ToFormatReport(ByVal query As String, ByVal sample As String)
    '    'Dim iRow = index
    '    'Dim cnn As SqlConnection
    '    Dim connectionString As String = Nothing
    '    Dim sql As String = Nothing
    ...
    '    'oDt.Dispose()
    '    ''-------------------------------- "D:\LoanSystem\Program\Report\DepositSchedule.xls"
    '    Dim excelBook As Excel.Workbook = xlApp.Workbooks.Open(frmMain.strPath & "\sample\"& sample, False, True)
    '    Dim excelWorksheet As Excel.Worksheet = CType(excelBook.Worksheets("Sheet1"), Excel.Worksheet)
    '    xlApp.Visible = True
    '    'cnn = New SqlConnection(connectionString1)
    '    'cnn.Open()
