...
Public Class Cls_qbPayroll
    ...
    'Public Sub FillMultiCombo(ByVal SQL As String, ByVal MCB As MultipleCombobox.mcb)
    '    Try
    '    Dim TEMP As String = MCB.Text
    ...
    '    dt.Columns.Add(0, GetType(System.String))
    '    dt.Columns.Add(1, GetType(System.String))
    '    Dim drDSRow As DataRow
    '    Dim drNewRow As DataRow
    '    For Each drDSRow In DS.Tables("SourceTable").Rows
    '        Application.DoEvents()
    '        drNewRow = dt.NewRow()
    '        drNewRow(0) = drDSRow(0)
    '        drNewRow(1) = drDSRow(1)
    '        dt.Rows.Add(drNewRow)
    '    Next
    '    MCB.DataSource = dt
    '    MCB.DisplayMember = dt.Columns(0).ToString
    '    MCB.ValueMember = dt.Columns(0).ToString
    '    MCB.SelectedValue = False
    '    con.Close()
    '    MCB.Text = TEMP
    'Catch ex As Exception
    ...
    '    Try
    '        For Each ChildForm As Form In Frm_Main.MdiChildren
    '            ChildForm.Close()
    '        Next
    '    Catch ex As Exception
    '        MsgBox(ex.Message)
    ...
    Public Sub OpenFormDock(ByVal frm As Form, ByVal tv As TreeView)
        Try
